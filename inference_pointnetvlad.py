...
from dataset_utils.kitti import pcl_parser_test as pars
...
if __name__ == '__main__':
  ...
  model = PointNetVlad(   global_feat=True, 
                          feature_transform=True, 
                          max_pool = False,
                          output_dim = ARCH['network']['output_dim'],
                          num_points = ARCH['network']['max_points']
                      )
  ...
  text_to_store['C'] =   round(SESSION['retrieval']['top_cand'],3)
